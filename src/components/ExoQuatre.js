	...
	return (
		<div className='jumbotron'>
			...
			<div className='d-flex flex-column'>
				<button
					onClick={
						display.class === 'd-none bg-danger w-25 p-4'
							? changerPlace2
							: changerPlace
					}
					className='btn btn-warning w-25 mx-auto m-2 text-center'>
					Changer place
				</button>
				<button className='btn btn-success w-25 mx-auto m-2 text-center'>
					Nbr de clicks : {display.value}{' '}
				</button>
			</div>
		</div>
	);
